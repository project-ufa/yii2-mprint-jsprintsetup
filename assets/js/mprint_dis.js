...
(function($) {
     ...
     */
        ...
        // if( result_jsp  && !printed_page )
        // {
        //     //alert("Imprimiendo Ticket");
        //     jsPrintSetup.printWindow(objFrame);
        //   /*alert("prepara la copia de la factura para impresión");
        //     jsPrintSetup.printWindow(objFrame);*/
        //     //jsPrintSetup.setSilentPrint(0);
        //     //
        //     //alert(mac);
        //     if(mac.return_printed)
        //     {
        //         //$('input[name="'+mac.return_printed+'"]').val('true');
                        
        //                 //alert('enviando imp');
        //         //setInterval( function(){ window.location = mac.redirUrl; }, 2000);
